...
const InfoCard = ({ icon, title, description, gradientBg, iconColor }) => (
  <div className="canva-card p-8 hover-scale group">
    <div
    ...
    <h3 className="font-bold text-xl mb-3" style={{ color: '#1C1C1E' }}>
      {title}
    </h3>
    <p className="text-base leading-relaxed" style={{ color: '#636366' }}>
      {description}
    </p>
  </div>
);
  ...
  const cards = [
    {
      ...
      gradientBg: 'bg-gradient-to-br from-blue-100 to-cyan-100',
    ...
    },
    {
      ...
      gradientBg: 'bg-gradient-to-br from-purple-100 to-pink-100',
